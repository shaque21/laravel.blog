...
<div class="row">
    <div class="col-md-9 offset-md-1">
        <div class="card">
            <form action="{{ url('/admin/update_post/'.$result['0']->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $result['0']->title }}" name="title" id="title" placeholder="Enter Title">   
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $result['0']->slug }}" name="slug" id="slug" placeholder="Enter Slug">   
                    @error('slug')
                        <span class="alert alert-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" value="{{ $result['0']->post_date }}" name="post_date" id="post_date" ">
                    @error('post_date')
                        <span class="alert alert-danger">{{ $message }}</span>
                    @enderror   
                </div>
