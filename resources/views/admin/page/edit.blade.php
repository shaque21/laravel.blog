...
<div class="row">
    <div class="col-md-9 offset-md-1">
        <div class="card">
            <form action="{{ url('/admin/update_page/'.$result['0']->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $result['0']->name }}" name="name" id="name" placeholder="Enter Name">   
                    @error('name')
